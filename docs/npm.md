...
Releases are managed through the [release.yml](https://github.com/aristoteleo/pantheon-cli/actions/workflows/release.yml) GitHub Actions workflow. To perform a manual release for a patch or hotfix:
...
Every night at midnight UTC, the [Release workflow](https://github.com/aristoteleo/pantheon-cli/actions/workflows/release.yml) runs automatically on a schedule. It performs the following steps:
...
After the workflow has successfully completed, you can monitor its progress in the [GitHub Actions tab](https://github.com/aristoteleo/pantheon-cli/actions/workflows/release.yml). Once complete, you should:

1.  Go to the [pull requests page](https://github.com/aristoteleo/pantheon-cli/pulls) of the repository.
...
1.  Go to the [Actions tab](https://github.com/aristoteleo/pantheon-cli/actions/workflows/release.yml) of the repository.
