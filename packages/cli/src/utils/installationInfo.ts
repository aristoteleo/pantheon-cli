...
export function getInstallationInfo(
  ...
  try {
    ...
    if (realPath.includes('/.pnpm/global')) {
      const updateCommand = 'pnpm add -g @aristoteleo/pantheon-cli@latest';
      return {
    ...
    if (realPath.includes('/.yarn/global')) {
      const updateCommand = 'yarn global add @aristoteleo/pantheon-cli@latest';
      return {
    ...
    if (realPath.includes('/.bun/bin')) {
      const updateCommand = 'bun add -g @aristoteleo/pantheon-cli@latest';
      return {
    ...
    // Assume global npm
    const updateCommand = 'npm install -g @aristoteleo/pantheon-cli@latest';
    return {
